...
public class ErrepikatzekoEskaeraEginGUI extends JFrame {
	...
	public void ErrepikatzekoEskaeraEginGUIExekuzioa() {
		...
		portzentaia.setBounds(433, 122, 186, 14);
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(apostatukoDena>0 && apustuaHilabetean>=1) {
					...
					if(selectedBezeroa.getKomisioAutomatikoa()==-1) {
						...
						selectedBezeroa=facade.bidaliMezua(selectedBezeroa, bezeroa, mezuOsoa, ResourceBundle.getBundle("Etiquetas").getString("Acceptance"), "errepikatuak eskaera onartu", apostatukoDena, apustuaHilabetean, selectedBezeroa.getKomisioAutomatikoa());
					}
		...
		invalid2.setBounds(525, 205, 73, 14);
